...
export function CommandPalette() {
  ...
  const commands: CommandItem[] = [
    ...
    },
    {
      id: "servicios",
      title: "Servicios",
      description: "Ver servicios de desarrollo de software",
      icon: Settings,
      action: () => window.location.href = withBase("/servicios"),
      category: "Navegación",
    },
    {
      id: "sobre-nosotros",
      title: "Sobre Nosotros",
      description: "Conoce Nukay",
      icon: FileText,
      action: () => window.location.href = withBase("/sobre-nosotros"),
      category: "Navegación",
    },
    {
      id: "contact",
      ...
      icon: Mail,
      action: () => window.location.href = withBase("/#contacto"),
      category: "Navegación",
    },
    {
      id: "toggle-theme",
